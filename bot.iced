...
server = http.createServer (req, res) ->
	...
	unless ipnParams.ipn_secret is moolah.ipn_secret
		return if ipnParams.ipn_secret is undefined
		return console.error "Incorrect IPN secret: #{ipnParams.ipn_secret}"
